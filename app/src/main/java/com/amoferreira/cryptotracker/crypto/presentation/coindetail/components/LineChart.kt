...
import com.amoferreira.cryptotracker.crypto.presentation.coindetail.ChartStyle
import com.amoferreira.cryptotracker.crypto.presentation.coindetail.DataPoint
import com.amoferreira.cryptotracker.crypto.presentation.coindetail.ValueLabel
            ...
            if (showHelperLines) {
                drawLine(
                    ...
                    strokeWidth = if (index == selectedDataPointIndex) {
                        style.helperLinesThicknessPx * 1.7f
                    } else {
